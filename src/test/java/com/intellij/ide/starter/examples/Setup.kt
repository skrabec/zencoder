...
class Setup {
  ...
  companion object {
    ...
    private val PATH_TO_INSTALLED_IDE = "C:\\Program Files\\JetBrains\\PyCharm Community Edition 2023.1.2\\bin"
    const val PROJECT_LOCATION = "C:/Users/skrab/PycharmProjects/getting-started-python"
    private val CONFIG_PATH = Paths.get(System.getProperty("user.home"), "AppData", "Roaming", "JetBrains", "PyCharmCE2023.1")
    private val PLUGINS_PATH = Paths.get(System.getProperty("user.home"), "AppData", "Roaming", "JetBrains", "PyCharmCE2023.1", "plugins")
